...
- **Per-platform install and service guides.** New Install wiki page and `docs/service.md` cover Linux systemd, macOS launchd, Windows SCM, Docker supervisor behavior, troubleshooting, and service runtime inspection. The README links to both guides from its service section. ([#360])
