...
# Run all offline tests (unit + integration, no credentials needed)
test:
    cargo test --all-features --bin kei --test cli --test state --test auth

# Run all tests including credential-dependent (requires .env)
test-all:
