...
| `heif_rewrite` | Byte-preserving HEIF XMP insertion and replacement, including non-XMP item payload and opaque `meta` sub-box validation | `src/download/heif.rs` |
